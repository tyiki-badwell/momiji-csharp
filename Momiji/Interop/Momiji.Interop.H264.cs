...
public struct SLayerBSInfo
{
    ...
    */
    ...
    public nint pNalLengthInByte;       ///< length of NAL size in byte from 0 to iNalCount-1
    public nint pBsBuf;       ///< buffer of bitstream contained
}
/**
...
internal class SSourcePicture
{
    ...
    public int iStride2;
    public int iStride3;
    public nint pData0;        ///< plane pData
    public nint pData1;
    public nint pData2;
    public nint pData3;
...
[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
internal readonly struct OpenH264Version
{
...
{
    public nint Initialize; //int (* Initialize) (ISVCEncoder*, const SEncParamBase* pParam);
    public nint InitializeExt; //int (* InitializeExt) (ISVCEncoder*, const SEncParamExt* pParam);
    public nint GetDefaultParams; //int (* GetDefaultParams) (ISVCEncoder*, SEncParamExt* pParam);
    public nint Uninitialize; //int (* Uninitialize) (ISVCEncoder*);
    public nint EncodeFrame; //int (* EncodeFrame) (ISVCEncoder*, const SSourcePicture* kpSrcPic, SFrameBSInfo* pBsInfo);
    public nint EncodeParameterSets; //int (* EncodeParameterSets) (ISVCEncoder*, SFrameBSInfo* pBsInfo);
    public nint ForceIntraFrame; //int (* ForceIntraFrame) (ISVCEncoder*, bool bIDR);
    public nint SetOption; //int (* SetOption) (ISVCEncoder*, ENCODER_OPTION eOptionId, void* pOption);
    public nint GetOption; //int (* GetOption) (ISVCEncoder*, ENCODER_OPTION eOptionId, void* pOption);
    ...
    */
    ...
    internal delegate int EncodeFrameProc(
        [In] SVCEncoder/*ISVCEncoder^*/	encoder,
        [In] nint/* SSourcePicture^*/ kpSrcPic,
        [In] nint/* SFrameBSInfo^*/ pBsInfo
    );
    /**
