...
public class FFTEncoder : IDisposable
{
    ...
    )
    {
        ...
        if (bitmapInput == default)
        {
            throw new InvalidOperationException("bitmapInput is null.");
        }
    ...
    )
    {
        ...
        {
            throw new InvalidOperationException("bitmapOutput is null.");
        }
        if (dest.SSourcePictureBuffer == default)
        {
            throw new InvalidOperationException("dest.SSourcePictureBuffer is null.");
        }
